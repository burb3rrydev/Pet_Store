...
public class PetStoreDataAccessObject {
    static final String DATABASE_URL = "jdbc:mysql://localhost:8889/my_pet_store";
    ...
    public int addOne(Pet newPet){
        try {
            ...
            String updateString = "INSERT INTO PETS (ID, NAME, DESCRIPTION, PRICE, PET_CATEGORIES_ID) VALUES (?, ?, ?, ?, ?)";
    ...
    public int updateOne(Pet newPet) {
        try {
            ...
            preparedStatement.setString(3, newPet.getDescription());
            preparedStatement.setDouble(4, newPet.getCategoryId());
